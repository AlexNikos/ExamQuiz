...
public class NewTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pickMultipleChoiseRecycleView = findViewById(R.id.pickMultiChoiceRecycleView);
        pickMultipleChoiseRecycleView.setHasFixedSize(true);
        pickMultipleChoiseRecycleView.setLayoutManager(new LinearLayoutManager(this));
...
//                                    }
        ...
        pickMultipleChoiseRecycleView.setAdapter(multipleChoicefirebaseRecyclerAdapter);
