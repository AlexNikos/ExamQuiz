...
public class TeacherActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nameView = (TextView) navigationView.getHeaderView(0).findViewById(R.id.teacher_nav_fullname);
        emailView = (TextView) navigationView.getHeaderView(0).findViewById(R.id.teacher_nav_email);
